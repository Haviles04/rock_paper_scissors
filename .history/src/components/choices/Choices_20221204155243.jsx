...
export default function Choices() {
  ...
  return (
    ...
    <div className={hardMode ? "grid grid-cols-5 justify-items-center grid-rows-3 w-screen h-500px " : "grid justify-items-center gap-x-[75px] grid-cols-5 grid-rows-2 w-[300px] h-[300px]"}>
      {choices.map((choice) => (
        <div
          key={choice.id}
