...
export default function Choices() {
  ...
  return (
    ...
    <div className={hardMode ? "grid grid-cols-5 justify-items-center grid-rows-3 w-screen h-500px" : "bg-[url('../../assets/images/bg-triangle.svg')] grid justify-items-center gap-x-[75px] grid-cols-5 grid-rows-2 w-[375px] h-[300px]"}>
      {choices.map((choice) => (
        <div
          key={choice.id}
