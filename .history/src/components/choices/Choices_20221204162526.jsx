    ...
    <div
      className={
        hardMode
          ...
          : " grid justify-items-center gap-x-[75px] grid-cols-5 grid-rows-2 w-[375px] h-[300px]"
      }
      style={{backgroundImage:`${bgTriangle}`, backgroundPosition:"center", backgroundRepeat:"no-repeat", backgroundSize:'cover'}}
    >
      {choices.map((choice) => (
        <div
          key={choice.id}
