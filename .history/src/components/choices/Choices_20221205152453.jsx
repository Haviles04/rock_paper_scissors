  ...
  return (
    ...
    >
      {choices.map((choice) => (
        <div
          key={choice.id}
          className={`col-start-${choice.col}  row-start-${choice.row} row m-5 w-[114px] h-[114px] rounded-full`}
          style={{
        ...
        >
          ...
          <button
            className="bg-gray-100 flex justify-center items-center w-[115px] h-[115px] p-5 rounded-full shadow-btnInner"
            style={{
              border: `8px solid ${choice.border}`,
            }}
          >
