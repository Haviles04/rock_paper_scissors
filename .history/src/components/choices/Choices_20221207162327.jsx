  ...
  return (
    <div className="flex justify-center align-center h-[300px]">
      <div
        className={
          hardMode
            ? "bg-hard bg-no-repeat bg-center bg-[length:60%] grid grid-cols-fiveItem justify-items-center grid-rows-test  h-[350px] md:grid-cols-fiveItemMD md:grid-rows-fiveItem"
