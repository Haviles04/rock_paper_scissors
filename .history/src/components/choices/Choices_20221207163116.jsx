  ...
  return (
    <div className="flex justify-center align-center h-[300px] md:h-[600px]">
      <div
        className={
          hardMode
            ? "bg-hard bg-no-repeat bg-center bg-[length:65%] grid grid-cols-fiveItem justify-items-center items-center grid-rows-test md:grid-cols-fiveItemMD md:grid-rows-fiveItem md:bg-[length:65%]"
