...
export default function Mode() {
  ...
  const handleChange = () => {
    ...
    dispatch(setChoices(gameMode === 'Easy' ? [{name: 'Rock', beats: 'Scissors'},{name: 'Paper', beats: 'Rock'},{name: 'Scissors', beats: 'Paper'}] : [...choices.concat([{name: 'Spock', beats: 'Lizard'},{name: 'Lizard', beats:'Spock'}])] ));
}
