...
export default function Results() {
  ...
  const compChoice = setTimeout(useSelector((state) => state.compChoice.value), Math.floor(Math.random) * 6)

  let selections = compChoice ? [playerChoice, compChoice] : [playerChoice];
