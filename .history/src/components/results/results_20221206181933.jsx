...
export default function Results() {
  ...
  return (
    <div className="flex text-center flex-wrap flex-row justify-around w-screen">
...
p-5 rounded-full shadow-btnInner mb-4 border-solid border-[9px] border-[${selection.border}]`}
      ...
      {winner ? (<div className="w-[500px] text-center text-white text-4xl"><span className="block">{winner}</span></div>) : null}
    </div>
  );
}
