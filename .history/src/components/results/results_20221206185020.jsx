...
export default function Results() {
  ...
  return (
    <div className="flex text-center flex-col w-screen">
...
p-5 rounded-full shadow-btnInner mb-4 border-solid border-[9px] border-[${selection.border}]`}
      ...
      <div className="text-center mt-20 text-white">
        {winner && <div className="flex flex-col justify-between"><div className="text-4xl">{winner}</div> <button className="mt-2 mb-[0px] border-2 p-2">Play Again</button></div>}
      </div>
    </div>
  );
}
