...
export default function Results() {
  ...
  return (
    <div className="flex text-center flex-col max-w-[500px] justify-around self-center  ">
      ...
      <div className="text-center mt-20 text-white">
        {winner && (
          <div>
            ...
            <button onClick={() => handleClick()} className="hover:scale-90 mt-10 w-[50%] border-2 rounded-lg p-2">
              Play Again
            </button>
          </div>
        )}
