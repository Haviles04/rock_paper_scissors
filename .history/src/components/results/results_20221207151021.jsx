...
export default function Results() {
  ...
  return (
    <div className="flex text-center flex-col h-[300px] min-w-[370px] md:max-w-[500px] self-center">
      <div className="grid grid-cols-5 grid-rows-1 justify-items-center">
        {selections.map((selection, index) =>
          selection ? (
            <div
              key={selection.name}
              className={`
w-[114px] h-[114px] text-center ${index === 1 ? 'col-start-2 row-start-1' : 'col-start-4 row-start-1'}
...
p-5 rounded-full shadow-btnInner mb-4 border-solid border-[9px] border-[${selection.border}]`}
            ...
            <div>
              <div className="col-start-4 row-start-1 opacity-75 mb-4 block bg-sky-100 rounded-full w-[115px] h-[115px]"></div>
