...
export default function Results() {
  ...
  return (
    <div className="flex text-center flex-col h-[300px] min-w-[350px] md:max-w-[500px] self-center">
      <div className="grid grid-cols-5 gap-x-[75px] grid-rows-1 justify-items-center">
