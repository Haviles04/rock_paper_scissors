...
export default function Results() {
  ...
  return (
    <div className="flex text-center flex-col h-[300px] min-w-[350px] md:max-w-[900px] self-center">
        ...
        {selections.map((selection, index) =>
          selection ? (
            <div
              key={selection.name}
              className={`
w-[114px] md:w-[299px] md:h-[299px] h-[114px] text-center ${index === 1 ? 'col-start-4 row-start-1' : 'col-start-2 row-start-1'}
rounded-full shadow-[0px_8px_${selection.shadow}] md:shadow-[0px_25px_${selection.shadow}]`}
            >
              <div
