...
export default function Results() {
  ...
  return (
    <div className="grid grid-cols-5 grid-rows-2 gap-x-[25px] md:grid-cols-results grid-rows-1 justify-items-center h-[300px] min-w-[350px] md:max-w-[900px] self-center">
