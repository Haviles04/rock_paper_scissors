      ...
      {selections.map((selection, index) =>
        selection ? (
          <div
            ...
            className={`
w-[114px] md:w-[274px] md:h-[274px] h-[114px] text-center ${
              index === 1
                ? "col-start-4 row-start-1"
                : "col-start-2 row-start-1"
            }
rounded-full m-5 shadow-[0px_8px_${selection.shadow}] md:shadow-[0px_20px_${
              selection.shadow
            }]`}
          >
            <div
...
p-5 rounded-full shadow-btnInner mb-4 md:mb-10 border-solid border-[9px] md:border-[30px] border-[${selection.border}]`}
            >
              <img
                className="md:h-[95px] h-[50px] shadow-2xl"
                alt={selection.name}
                src={selection.image}
              />
            </div>
          ...
          <div
            key="choosing"
            className="col-start-4 row-start-1 m-5 text-center "
          >
