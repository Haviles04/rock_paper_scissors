...
export default function Rules() {
    ...
    <div className='absolute h-screen w-screen bg-white z-10 flex flex-col items-center justify-evenly text-center md:h-[600px] md:w-[600px] md:relative md:self-center md:rounded-xl' >
        ...
        <div className='md:self-start ml-10'>
        <span className='text-3xl font-bold'>Rules</span></div>
        <div >
        <img  alt='rules' src={hardMode ? hardModeRules : easyModeRules} /></div>
        <div className='md:self-end mr-10'><button onClick={()=> dispatch(setShowRules(showRules))}><img alt='close' src={iconClose} /> </button></div> 
