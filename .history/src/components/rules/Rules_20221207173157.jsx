...
export default function Rules() {
  ...
  return (
    <div className="absolute h-screen w-screen bg-white z-10 flex flex-col items-center justify-evenly text-center md:h-[400px] md:w-[600px] md:relative md:self-center md:rounded-xl md:flex-row">
      <div className="md:flex md:flex-row md:flex-wrap md:w-full md:h:full md:justify-between">
        ...
        <div className="md:order-last md:w-full md:justify-self-center md:flex md:justify-center">
          <img
