...
export default function Rules() {
  ...
  return (
    <div className="absolute h-screen w-screen bg-white z-10 flex flex-col items-center justify-evenly text-center md:h-[600px] md:w-[600px]  md:rounded-xl md:flex-row">
