...
export default function Rules() {
  ...
  return (
    <div className="absolute h-screen w-screen bg-white z-10 flex flex-col items-center justify-evenly text-center md:h-[500px] md:w-[500px]  md:rounded-xl md:flex-row md:t-0 md:right-0 md:bottom-0">
