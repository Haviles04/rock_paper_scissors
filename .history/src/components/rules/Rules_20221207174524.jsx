...
export default function Rules() {
  ...
  return (
    <div className="absolute h-screen w-screen bg-white z-10 flex flex-col items-center justify-evenly text-center md:opacity-90 md:rounded-xl md:flex-row md:top-0 md:right-0 md:bottom-0 md:left-0 md:m-auto">
      <div className="md:flex md:flex-row md:flex-wrap md:w-full md:h:full md:justify-between md:h-[500px] md:w-[500px] md:opacity-100 ">
        <div>
