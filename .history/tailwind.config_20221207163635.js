...
module.exports = {
  ...
  theme: {
    extend: {
      ...
      gridTemplateColumns:{
        ...
        'fiveItemMD': '80px 80px 80px 115px 80px 80px 80px',
        'results' : '1fr 1fr 2fr 1fr 1fr'
      },
      gridTemplateRows: {
        'test' : '90px 80px 50px 70px',
        'fiveItem' : '150px 140px 70px 70px'
      },
      boxShadow: {
  ...
  safelist: [
    ...
    'md:shadow-[0px_12px_#4865f4]',
    'md:shadow-[0px_12px_#ec9e0e]',
    'md:shadow-[0px_12px_#dc2e4e]',
    'md:shadow-[0px_12px_#834fe3]',
    'md:shadow-[0px_12px_#40b9ce]',
  ]
}
